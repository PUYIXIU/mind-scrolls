...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/devalue/index.js';
import destr from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/wsy/register/other/WebServer/mind-scrolls/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/wsy/register/other/WebServer/mind-scrolls/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\wsy\\register\\other\\WebServer\\mind-scrolls","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\wsy\\register\\other\\WebServer\\mind-scrolls\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\wsy\\register\\other\\WebServer\\mind-scrolls\\nuxt-build","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\wsy\\register\\other\\WebServer\\mind-scrolls\\nuxt-build\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\wsy\\register\\other\\WebServer\\mind-scrolls\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "E:/wsy/register/other/WebServer/mind-scrolls";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _moXZQt9zMJ = (nitroApp) => {
...
const _lazy_UZnxxx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_UZnxxx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_UZnxxx, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/e-duck.png"}],"style":[],"script":[],"noscript":[],"title":"Mind Scrolls | 脑轴"};
...
const getClientManifest = () => import('file://E:/wsy/register/other/WebServer/mind-scrolls/nuxt-build/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/wsy/register/other/WebServer/mind-scrolls/nuxt-build/dist/server/server.mjs').then((r) => r.default || r);
